...
[ML Config](../mlops_project_0713/databricks-resources/README.md)  guides to make changes to ML code or deployed jobs.
...
```
git add README.md docs .gitignore mlops_project_0713/databricks-resources/README.md
...
* [databricks-dev.yaml](../mlops_project_0713/training/profiles/databricks-dev.yaml): specify recipe configs to use in dev workspace
* [databricks-staging.yaml](../mlops_project_0713/training/profiles/databricks-staging.yaml): specify recipe configs to use in recurring model training and batch inference
  jobs that run in the staging workspace
* [databricks-prod.yaml](../mlops_project_0713/training/profiles/databricks-prod.yaml) specify recipe configs to use in recurring model training and batch inference
  jobs that run in the prod workspace
* [databricks-test.yaml](../mlops_project_0713/training/profiles/databricks-test.yaml): specify recipe configs to use in integration tests(CI)
...
Follow the instructions in [mlops-project-0713/databricks-resources/README.md](../mlops_project_0713/databricks-resources/README.md) to deploy ML resources
and production jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML resource config guide](../mlops_project_0713/databricks-resources/README.md)  to propose, test, and deploy
