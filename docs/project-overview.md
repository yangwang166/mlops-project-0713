...
```
mlops-project-0713         <- Root directory. Both monorepo and polyrepo are supported.
│
├── mlops_project_0713       <- Contains python code, notebooks and ML resources related to one ML project. 
│   │
